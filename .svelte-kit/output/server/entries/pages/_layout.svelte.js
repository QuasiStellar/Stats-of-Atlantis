...
const smallLogoImage = "/_app/immutable/assets/small_logo.3e62f691.png";
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Navbar, "Navbar").$$render(
    $$result,
    {
      class: "fixed z-50 top-0 border-b bg-dark-800 border-b-dark-600"
    },
    {},
    {
      default: () => {
        return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
          default: () => {
            return `<img${add_attribute("src", smallLogoImage, 0)} class="mr-3 h-6 sm:h-9" alt="SoA Logo"> <span class="whitespace-nowrap text-2xl font-semibold text-white" data-svelte-h="svelte-iwdhny">Stats of Atlantis</span>`;
          }
        })} ${validate_component(NavHamburger, "NavHamburger").$$render($$result, { class: "text-dark-400 hover:bg-dark-600" }, {}, {})} ${validate_component(NavUl, "NavUl").$$render(
          $$result,
          {
            activeUrl,
          ...
          {
            default: () => {
              return `${validate_component(NavLi, "NavLi").$$render($$result, { class: "text-dark-400", href: "/" }, {}, {
                default: () => {
                  return `Catalogue`;
                }
              })} ${validate_component(NavLi, "NavLi").$$render($$result, { class: "text-dark-400", href: "/builder" }, {}, {
                default: () => {
                  return `Card Builder`;
                }
              })} ${validate_component(NavLi, "NavLi").$$render($$result, { class: "text-dark-400", href: "/about" }, {}, {
                default: () => {
                  return `About`;
                }
              })}`;
