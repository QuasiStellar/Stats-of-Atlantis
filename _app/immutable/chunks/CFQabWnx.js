...
the enemy hero must use the ::initiative:: Initiative
value of their card and items instead of the
::defense_silver:: Defense value of their card and items.`,color:`RED`,level:3,variant:{first:1,second:2},initiative:8,primaryAction:`ATTACK`,primaryValue:12,secondaryMovement:3,secondaryDefense:8,item:`RANGE`,traits:[`ATTACK_UNIT`]},{name:`D�j� Vu`,description:`Target a unit adjacent to you. After the attack:
...
count as obstacles for enemy units.`,color:`RED`,level:2,variant:{first:2,second:2},initiative:11,primaryAction:`ATTACK`,primaryValue:3,secondaryMovement:1,secondaryDefense:2,item:`DEFENSE`,traits:[`THIS_TURN`,`AFTER_THE_ATTACK`,`COUNTS_AS`,`ATTACK_UNIT`]},{name:`Hold my Sak�`,description:`Target a unit adjacent to you.
After the attack: A friendly hero in radius
