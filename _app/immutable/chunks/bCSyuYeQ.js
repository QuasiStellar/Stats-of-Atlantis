...
>>Target a unit adjacent to you.
>>Target a hero in range, adjacent to your
>friendly hero and not adjacent to you.`,color:`RED`,level:3,variant:{first:1,second:2},initiative:10,primaryAction:`ATTACK`,primaryValue:4,modifier:`RANGE`,modifierValue:4,secondaryMovement:5,secondaryDefense:5,item:`MOVEMENT`,traits:[`HIGH_RANGE_ATTACK`,`MULTIPLE_CHOICE`,`ATTACK_UNIT`,`ATTACK_HERO`]},{name:`Monkey Business`,description:`Swap two friendly units in radius.
...
>space adjacent to that enemy hero.
>>Place an enemy minion in radius into a
>space adjacent to you.`,color:`GREEN`,level:2,variant:{first:1,second:2},initiative:4,primaryAction:`MOVEMENT`,primaryValue:2,modifier:`AREA`,modifierValue:3,secondaryDefense:4,item:`ATTACK`,traits:[`PLACING_TEAM`,`PLACING_ENEMY`,`MULTIPLE_CHOICE`]},{name:`Opening Shots`,description:`If both you and an enemy hero in radius
...
discard a card, if able. Remove the Turret.`,color:`GREEN`,level:2,variant:{first:2,second:2},initiative:3,primaryAction:`SKILL`,modifier:`AREA`,modifierValue:3,secondaryMovement:2,secondaryDefense:2,item:`DEFENSE`,traits:[`REMOVING`]},{name:`Disruptor Grid`,description:`**This turn:** Before any enemy hero in radius
of the Turret performs a primary action,
...
adjacent to you into a space in range.`,color:`GREEN`,level:2,variant:{first:1,second:2},initiative:5,primaryAction:`SKILL`,modifier:`RANGE`,modifierValue:4,secondaryMovement:2,secondaryDefense:4,item:`ATTACK`,traits:[`PLACING_TOKENS`,`USING_TOKENS`]},{name:`Claim Dominance`,description:`**This round:** Up to 1 enemy minion adjacent
