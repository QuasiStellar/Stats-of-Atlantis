import{$ as e,A as t,B as n,C as r,D as i,Et as a,F as o,H as s,I as c,J as l,K as u,L as d,Q as f,R as p,S as ee,St as te,Tt as ne,W as re,Y as m,Z as ie,ct as h,d as g,dt as _,ft as ae,ht as oe,lt as se,nt as ce,o as le,pt as v,r as ue,rt as y,st as b,tt as x,u as de,ut as S,xt as fe,y as C,z as pe}from"../chunks/CS0M2_kq.js";import{n as me}from"../chunks/BT8FyXsz.js";import"../chunks/D9FQP20W.js";import"../chunks/CtL2kW5j.js";import{C as w,i as he,l as ge,o as _e,w as ve,y as T}from"../chunks/CD-ZKRqW.js";import{a as ye,c as be,i as xe,n as Se,o as Ce,r as we,s as Te,t as Ee}from"../chunks/JVtFCkDH.js";import{_ as De,c as Oe,d as ke,n as E,p as Ae,r as je,s as Me,t as D}from"../chunks/DUFTyf2k.js";import{i as Ne,n as Pe,r as Fe,t as Ie}from"../chunks/ClFY4jpr.js";import{C as Le,S as Re,_ as ze,a as Be,b as Ve,c as He,d as Ue,f as We,g as Ge,h as Ke,i as qe,l as Je,m as Ye,n as Xe,o as Ze,p as Qe,r as $e,s as et,t as tt,u as nt,v as rt,x as it,y as at}from"../chunks/CFQabWnx.js";var ot=``+new URL(`../assets/arien.BnZh9Qa-.webp`,import.meta.url).href,st=``+new URL(`../assets/bain.CklpntrI.webp`,import.meta.url).href,ct=``+new URL(`../assets/brogan.BeXQ9VLh.webp`,import.meta.url).href,lt=``+new URL(`../assets/brynn.DjkXgrbv.webp`,import.meta.url).href,ut=``+new URL(`../assets/cutter.Bl7NYnWh.webp`,import.meta.url).href,dt=``+new URL(`../assets/dodger.DUsiyFPT.webp`,import.meta.url).href,ft=``+new URL(`../assets/emmitt.1117UxR5.webp`,import.meta.url).href,pt=``+new URL(`../assets/garrus.DPFrzyJJ.webp`,import.meta.url).href,mt=``+new URL(`../assets/gydion.RRcJAsqU.webp`,import.meta.url).href,ht=``+new URL(`../assets/hanu.iN5c8elP.webp`,import.meta.url).href,gt=``+new URL(`../assets/ignatia.1aFd1RMn.webp`,import.meta.url).href,_t=``+new URL(`../assets/min.BG4tPnhJ.webp`,import.meta.url).href,vt=``+new URL(`../assets/misa.C6Dnj7_I.webp`,import.meta.url).href,yt=``+new URL(`../assets/mortimer.DhcPJGX5.webp`,import.meta.url).href,bt=``+new URL(`../assets/mrak.BO4zlaCk.webp`,import.meta.url).href,xt=``+new URL(`../assets/nebkher.CGqaqJW1.webp`,import.meta.url).href,St=``+new URL(`../assets/razzle.BB41Uaf8.webp`,import.meta.url).href,Ct=``+new URL(`../assets/rowenna.hsYQ-q0C.webp`,import.meta.url).href,wt=``+new URL(`../assets/sabina.zAE08BdQ.webp`,import.meta.url).href,Tt=``+new URL(`../assets/silverarrow.Cob1dojq.webp`,import.meta.url).href,Et=``+new URL(`../assets/snorri.DcW6XJQX.webp`,import.meta.url).href,Dt=``+new URL(`../assets/swift.sq2NK_k4.webp`,import.meta.url).href,Ot=``+new URL(`../assets/takahide.DgDmb7V7.webp`,import.meta.url).href,kt=``+new URL(`../assets/tali.DcFkA1lL.webp`,import.meta.url).href,At=``+new URL(`../assets/tigerclaw.CZOzemvV.webp`,import.meta.url).href,jt=``+new URL(`../assets/trinkets.Dl9ox7fO.webp`,import.meta.url).href,Mt=``+new URL(`../assets/ursafar.CMVSDtkV.webp`,import.meta.url).href,Nt=``+new URL(`../assets/wasp.DgSBKuHc.webp`,import.meta.url).href,Pt=``+new URL(`../assets/whisper.BfS0Lmvz.webp`,import.meta.url).href,Ft=``+new URL(`../assets/widget.B6qkfcYc.webp`,import.meta.url).href,It=``+new URL(`../assets/wuk.J3i6Xvoc.webp`,import.meta.url).href,Lt=``+new URL(`../assets/xargatha.Co9sdKj_.webp`,import.meta.url).href,Rt={arien:[{name:`Noble Blade`,description:`Before the attack: You may move another
...
a movement action on a gold card.`,color:`GREEN`,level:3,variant:{first:2,second:2},initiative:4,primaryAction:`MOVEMENT`,primaryValue:2,secondaryDefense:4,item:`DEFENSE`}]},zt=s(`<div></div>`),Bt=s(`<div></div>`),Vt=s(`<div class="float-left w-[5.6px] xs:w-[7px] sm:w-[12px] lg:w-5 h-1 bg-transparent"></div>`),Ht=s(`<div class="float-left w-0.5 sm:w-0.75 lg:w-1 h-1"></div> <!>`,1),Ut=s(`<div class="col-span-3 h-3 xs:h-4 sm:h-5.5 lg:h-7 z-20 relative"><div class="left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 h-2.5 xs:h-3 sm:h-4 lg:h-5 border border-dark-600 bg-transparent hover:bg-transparent rounded sm:rounded-lg lg:rounded-xl bg-dark-900 absolute"><div class="m-0.5 sm:m-0.5 lg:m-1 relative h-full"><!> <div class="float-left w-2 xs:w-3.5 sm:w-6 lg:w-7 h-full bg-transparent"></div> <!></div></div></div> <!>`,1),Wt=s(`<div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Gold I spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Gold II spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Gold III spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div></div>`,1),Gt=s(`<div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Blue IA spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Red IA spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Green IA spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div></div>`,1),Kt=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Blue tier II spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),qt=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Red tier II spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),Jt=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Green tier II spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),Yt=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Blue tier II extra spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),Xt=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Red tier II extra spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),Zt=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Green tier II extra spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),Qt=s(`<div class="col-span-12 grid grid-cols-12"><div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><!></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><!></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><!></div></div>`),$t=s(`<div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><!></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><!></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative"><!></div> <!>`,1),en=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Blue tier III spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),tn=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Red tier III spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),nn=s(`<div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Green tier III spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div>`),rn=s(`<div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative z-0"><!></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative z-0"><!></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative z-0"><!></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative z-0"></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative z-0"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute overflow-hidden"><img alt="Ultimate spell card" class="w-full h-full rounded-lg sm:rounded-xl lg:rounded-3xl object-cover"/></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-19 xs:h-22 sm:h-37.5 lg:h-57 relative z-0"></div>`,1),an=s(`<div class="w-26 xs:w-32 sm:w-52 lg:w-80 h-35 xs:h-44 sm:h-73 lg:h-111 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute"><canvas width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas></div></div>`),on=s(`<div class="col-span-12 mt-[3px] xs:mt-[2px] sm:mt-[2px] lg:mt-[0px] flex justify-center gap-2 xs:gap-3 sm:gap-4 lg:gap-6 relative z-0"></div>`),sn=s(`<div>Show Numbers</div>`),cn=s(`<div style="color: white">Show Handicap</div>`),ln=s(`<div class="flex md:mt-20 mt-16 mb-52"><div class="grid grid-cols-12 m-auto"><div class="col-span-12 w-78 xs:w-96 sm:w-157 lg:w-239 h-[155px] xs:h-[190px] sm:h-[313px] lg:h-[473px] mt-4 xs:mt-5 sm:mt-7.5 lg:mt-10 relative"><div class="border border-dark-600 rounded-lg sm:rounded-xl lg:rounded-3xl left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 w-77.5 xs:w-95 sm:w-156 lg:w-237 absolute"><!> <p class="absolute text-black xs:text-xl sm:text-3xl lg:text-5xl -top-[14px] sm:-top-[19px] lg:-top-[24px] left-[10px] sm:left-[22px] lg:left-[34px] font-modesto svelte-116f7tl"> </p> <p class="absolute text-black xs:text-xl sm:text-3xl lg:text-5xl -top-[10px] sm:-top-[13px] lg:-top-[16px] left-[6px] sm:left-[16px] lg:left-[26px] font-modesto svelte-116f7tl"> </p> <p class="absolute text-black xs:text-xl sm:text-3xl lg:text-5xl -top-[14px] sm:-top-[19px] lg:-top-[24px] left-[6px] sm:left-[16px] lg:left-[26px] font-modesto svelte-116f7tl"> </p> <p class="absolute text-black xs:text-xl sm:text-3xl lg:text-5xl -top-[10px] sm:-top-[13px] lg:-top-[16px] left-[10px] sm:left-[22px] lg:left-[34px] font-modesto svelte-116f7tl"> </p> <p class="absolute text-white xs:text-xl sm:text-3xl lg:text-5xl -top-[12px] sm:-top-[16px] lg:-top-[20px] left-[8px] sm:left-[19px] lg:left-[30px] font-modesto svelte-116f7tl"> </p></div></div> <!> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-36 xs:h-44 sm:h-73 lg:h-111 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute"><canvas id="goldCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-36 xs:h-44 sm:h-73 lg:h-111 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute"><canvas id="silverCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-36 xs:h-44 sm:h-73 lg:h-111 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute"><canvas id="purpleCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas></div></div> <!> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-35 xs:h-44 sm:h-73 lg:h-111 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute"><canvas id="blueICanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-35 xs:h-44 sm:h-73 lg:h-111 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute"><canvas id="redICanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-35 xs:h-44 sm:h-73 lg:h-111 relative"><div class="border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 top-0.25 xs:top-0.5 sm:top-0.5 lg:top-1 absolute"><canvas id="greenICanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas></div></div> <!> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-40 xs:h-49 sm:h-81 lg:h-124 relative z-10"><div><canvas id="blueIIaltCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div> <div><canvas id="blueIImainCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-40 xs:h-49 sm:h-81 lg:h-124 relative z-10"><div><canvas id="redIIaltCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div> <div><canvas id="redIImainCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-40 xs:h-49 sm:h-81 lg:h-124 relative z-10"><div><canvas id="greenIIaltCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div> <div><canvas id="greenIImainCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div></div> <!> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-40 xs:h-49 sm:h-81 lg:h-124 relative z-10"><div><canvas id="blueIIIaltCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div> <div><canvas id="blueIIImainCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-40 xs:h-49 sm:h-81 lg:h-124 relative z-10"><div><canvas id="redIIIaltCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div> <div><canvas id="redIIImainCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div></div> <div class="col-span-4 w-26 xs:w-32 sm:w-52 lg:w-80 h-40 xs:h-49 sm:h-81 lg:h-124 relative z-10"><div><canvas id="greenIIIaltCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div> <div><canvas id="greenIIImainCanvas" width="1192" height="1664" class="w-full rounded-lg sm:rounded-xl lg:rounded-3xl"></canvas> <!></div></div> <!> <!> <div id="showNumbers" class="col-span-6 flex-col content-center mt-8 xs:mt-10 sm:mt-14 flex items-center"><!> <!></div> <div class="col-span-6 flex-col content-center mt-8 xs:mt-10 sm:mt-14 flex items-center"><!></div></div> <p class="absolute font-modesto svelte-116f7tl"></p></div>`);function O(e,i){te(i,!1);let s=_(),b=_(),me=_(),O=_(),k=_(),A=_(),j=_(),un=_(),dn=_(),fn={duration:500,easing:ge,axis:`y`},M={y:36,duration:500},pn={y:-28,duration:500},mn={y:28,duration:500},hn=`data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=`,gn=Object.assign({"../../lib/images/stat_icons/attack_white.png":be,"../../lib/images/stat_icons/brawler_white.png":Te,"../../lib/images/stat_icons/defense_white.png":Ce,"../../lib/images/stat_icons/initiative_white.png":ye,"../../lib/images/stat_icons/initiator_white.png":xe,"../../lib/images/stat_icons/movement_white.png":we,"../../lib/images/stat_icons/pusher_white.png":Se,"../../lib/images/stat_icons/support_white.png":Ee}),_n=Object.assign({"../../lib/images/avatars_full/arien.webp":ot,"../../lib/images/avatars_full/bain.webp":st,"../../lib/images/avatars_full/brogan.webp":ct,"../../lib/images/avatars_full/brynn.webp":lt,"../../lib/images/avatars_full/cutter.webp":ut,"../../lib/images/avatars_full/dodger.webp":dt,"../../lib/images/avatars_full/emmitt.webp":ft,"../../lib/images/avatars_full/garrus.webp":pt,"../../lib/images/avatars_full/gydion.webp":mt,"../../lib/images/avatars_full/hanu.webp":ht,"../../lib/images/avatars_full/ignatia.webp":gt,"../../lib/images/avatars_full/min.webp":_t,"../../lib/images/avatars_full/misa.webp":vt,"../../lib/images/avatars_full/mortimer.webp":yt,"../../lib/images/avatars_full/mrak.webp":bt,"../../lib/images/avatars_full/nebkher.webp":xt,"../../lib/images/avatars_full/razzle.webp":St,"../../lib/images/avatars_full/rowenna.webp":Ct,"../../lib/images/avatars_full/sabina.webp":wt,"../../lib/images/avatars_full/silverarrow.webp":Tt,"../../lib/images/avatars_full/snorri.webp":Et,"../../lib/images/avatars_full/swift.webp":Dt,"../../lib/images/avatars_full/takahide.webp":Ot,"../../lib/images/avatars_full/tali.webp":kt,"../../lib/images/avatars_full/tigerclaw.webp":At,"../../lib/images/avatars_full/trinkets.webp":jt,"../../lib/images/avatars_full/ursafar.webp":Mt,"../../lib/images/avatars_full/wasp.webp":Nt,"../../lib/images/avatars_full/whisper.webp":Pt,"../../lib/images/avatars_full/widget.webp":Ft,"../../lib/images/avatars_full/wuk.webp":It,"../../lib/images/avatars_full/xargatha.webp":Lt}),vn=Object.assign({"../../lib/images/spell_cards/BlueIA.webp":Le,"../../lib/images/spell_cards/BlueIIA.webp":Re,"../../lib/images/spell_cards/BlueIIB.webp":it,"../../lib/images/spell_cards/BlueIIB2.webp":Ve,"../../lib/images/spell_cards/BlueIIIA.webp":at,"../../lib/images/spell_cards/BlueIIIB.webp":rt,"../../lib/images/spell_cards/GoldI.webp":ze,"../../lib/images/spell_cards/GoldII.webp":Ge,"../../lib/images/spell_cards/GoldIII.webp":Ke,"../../lib/images/spell_cards/GreenIA.webp":Ye,"../../lib/images/spell_cards/GreenIIA.webp":Qe,"../../lib/images/spell_cards/GreenIIB.webp":We,"../../lib/images/spell_cards/GreenIIB2.webp":Ue,"../../lib/images/spell_cards/GreenIIIA.webp":nt,"../../lib/images/spell_cards/GreenIIIB.webp":Je,"../../lib/images/spell_cards/RedIA.webp":He,"../../lib/images/spell_cards/RedIIA.webp":et,"../../lib/images/spell_cards/RedIIB.webp":Ze,"../../lib/images/spell_cards/RedIIB2.webp":Be,"../../lib/images/spell_cards/RedIIIA.webp":qe,"../../lib/images/spell_cards/RedIIIB.webp":$e,"../../lib/images/spell_cards/Ultimate.webp":Xe}),N=le(i,`heroName`,8),yn=le(i,`useNewPrinting`,8,!0),bn=_(),xn=_(),Sn=_(),Cn=_(),wn=_(),Tn=_(),En=_(),Dn=_(),On=_(),kn=_(),An=_(),jn=_(),Mn=_(),Nn=_(),Pn=_(),Fn=_(),In=_(),Ln=_(),Rn=_(),zn=_(),Bn=_(),Vn=_(),Hn=_(),Un=_(),Wn=_(),Gn=_(),Kn=_(),qn=_(),Jn=_(),Yn=_(),Xn=_(),Zn=_(),Qn=_(),$n=_(),er=_(),tr=_(),nr=_(),rr=_(),ir=_(),ar=_(),or=_(),sr=_(),cr=_(),lr=_(),ur=_(),dr=_(),fr=_(),pr=_(),mr=_(),hr=_(),gr=_(),_r=_(),vr=_(),yr=_(),br=_(),P=_([]),xr=_([]),Sr=_([]),Cr=_([]),wr=_([]),F=_(!1),Tr=`goa-show-numbers`,Er=_(!1),Dr=_(!1),Or=_(!1),kr=_(!1),Ar=_(!1),jr=_(!1),Mr=_(!1),Nr=_(!1),Pr=_(!1),Fr=_(!1),Ir=_(!1),Lr=_(!1),Rr=_(!1),zr=_(!1),Br=_(!1),Vr=_(!1),Hr=_(!1),Ur=_(!1),Wr=_(!1),Gr=_(!1),Kr=_(!1),I=_(!1),L=_(!1),R=_(!1),z=_(!1),B=_(!1),V=_(!1),qr=_(!1),Jr=_(!1),Yr=_(),Xr=_(),Zr=_(),H=_(),Qr=_(),$r=_(),ei=_(),ti=_(),ni=_(),ri=_(),ii=_(),ai=_(),oi=_(),si=_(),ci=_(),li=_(),ui=_(),di=_(),fi=_(),pi=_(),mi=_(0),hi=_(0),gi=_(0),_i=_(0),vi=_(0),yi=_(0),U=_(!1),W=_(!1),G=_(!1),K=_(!1),bi=_(!1),q=_(!1),xi=_(!1),J=_(!1),Si=_(!1),Y=_(!1),Ci=_(!1),X=_(!1);function wi(e){e.target.checked&&v(W,!1)}function Ti(e){e.target.checked&&v(U,!1)}function Ei(e){e.target.checked&&v(K,!1)}function Di(e){e.target.checked&&v(G,!1)}function Oi(e){e.target.checked&&v(q,!1)}function ki(e){e.target.checked&&v(bi,!1)}function Ai(e){e.target.checked&&v(J,!1)}function ji(e){e.target.checked&&v(xi,!1)}function Mi(e){e.target.checked&&v(Y,!1)}function Ni(e){e.target.checked&&v(Si,!1)}function Pi(e){e.target.checked&&v(X,!1)}function Fi(e){e.target.checked&&v(Ci,!1)}function Ii(){m(U)&&m(W)&&v(W,!1),m(G)&&m(K)&&v(K,!1),m(bi)&&m(q)&&v(q,!1),m(xi)&&m(J)&&v(J,!1),m(Si)&&m(Y)&&v(Y,!1),m(Ci)&&m(X)&&v(X,!1)}function Li(){return`goa-hero-upgrades:${yn()?`new`:`old`}:${N()}`}function Ri(e){typeof e.blueIIalt==`boolean`&&v(I,e.blueIIalt),typeof e.redIIalt==`boolean`&&v(L,e.redIIalt),typeof e.greenIIalt==`boolean`&&v(R,e.greenIIalt),typeof e.blueIIIalt==`boolean`&&v(z,e.blueIIIalt),typeof e.redIIIalt==`boolean`&&v(B,e.redIIIalt),typeof e.greenIIIalt==`boolean`&&v(V,e.greenIIIalt),typeof e.blueIIaltChecked==`boolean`&&v(U,e.blueIIaltChecked),typeof e.blueIImainChecked==`boolean`&&v(W,e.blueIImainChecked),typeof e.redIIaltChecked==`boolean`&&v(G,e.redIIaltChecked),typeof e.redIImainChecked==`boolean`&&v(K,e.redIImainChecked),typeof e.greenIIaltChecked==`boolean`&&v(bi,e.greenIIaltChecked),typeof e.greenIImainChecked==`boolean`&&v(q,e.greenIImainChecked),typeof e.blueIIIaltChecked==`boolean`&&v(xi,e.blueIIIaltChecked),typeof e.blueIIImainChecked==`boolean`&&v(J,e.blueIIImainChecked),typeof e.redIIIaltChecked==`boolean`&&v(Si,e.redIIIaltChecked),typeof e.redIIImainChecked==`boolean`&&v(Y,e.redIIImainChecked),typeof e.greenIIIaltChecked==`boolean`&&v(Ci,e.greenIIIaltChecked),typeof e.greenIIImainChecked==`boolean`&&v(X,e.greenIIImainChecked),Ii()}let zi=_(localStorage.getItem(Tr)===`true`),Bi=e=>e?`gray`:`white`,Vi=_(),Hi=_(``);function Ui(e){return e==null?{min:0,max:0}:Array.isArray(e)?{min:e[0],max:e[1]}:{min:e,max:e}}function Wi(e){let{min:t,max:n}=Ui(m(Vi)?.stats?.[e]);return yn()?t:n}async function Gi(e){let t=Math.min(744,e.width),n=Math.min(1039,e.height),r=(e.width-t)/2,i=(e.height-n)/2,a=document.createElement(`canvas`);a.width=t,a.height=n;let o=a.getContext(`2d`);if(o==null)return e;o.drawImage(e,r,i,t,n,0,0,t,n);let s=new Image;return s.src=a.toDataURL(),await new Promise(t=>{s.onload=()=>t(s),s.onerror=()=>t(e)})}async function Z(e){await Pe(N(),e);let t=Ie.get(e);if(t instanceof HTMLImageElement)return await Gi(t)}function Q(e,t,n,r){Ne(e,t,[],r,n.color??D.GOLD,n.handicapped??!1,n.extra??!1,n.name??``,n.description??``,`i`.repeat(n.level??1),n.item??E.ATTACK,n.initiative??0,n.primaryAction??Me.ATTACK,n.primaryValue??0,n.primaryValueSign??Oe.NONE,n.modifier??je.NONE,n.modifierValue??0,n.modifierValueSign??Oe.NONE,n.secondaryMovement??0,n.secondaryDefense??0,n.secondaryAttack??null,m(mi),m(hi),m(gi),m(_i),m(vi),m(yi),m(zi),Wi(0),Wi(1),Wi(2),Wi(3))}let Ki=_();function qi(e){return _n[`../../lib/images/avatars_full/${e}.webp`]??hn}function Ji(e){return gn[`../../lib/images/stat_icons/${e}_white.png`]??hn}function $(e){return vn[`../../lib/images/spell_cards/${e}.webp`]??hn}ue(async()=>{let e=localStorage.getItem(Li());if(e)try{Ri(JSON.parse(e))}catch{}v(Er,!0),v(Ki,qi(N())),v(xn,m(bn).getContext(`2d`)),v(Tn,m(wn).getContext(`2d`)),v(On,m(Dn).getContext(`2d`)),v(jn,m(An).getContext(`2d`)),v(Pn,m(Nn).getContext(`2d`)),v(Ln,m(In).getContext(`2d`)),v(Bn,m(zn).getContext(`2d`)),v(Un,m(Hn).getContext(`2d`)),v(Kn,m(Gn).getContext(`2d`)),v(Yn,m(Jn).getContext(`2d`)),v(Qn,m(Zn).getContext(`2d`)),v(tr,m(er).getContext(`2d`)),v(ir,m(rr).getContext(`2d`)),v(sr,m(or).getContext(`2d`)),v(ur,m(lr).getContext(`2d`)),v(pr,m(fr).getContext(`2d`)),v(gr,m(hr).getContext(`2d`)),v(yr,m(vr).getContext(`2d`)),Promise.all([document.fonts.ready,Fe()]).then(()=>{v(F,!0);let e=(yn()?tt:Rt)[N()];e!=null&&(v(Yr,e.find(e=>e.color==D.GOLD.toUpperCase())),v(Xr,e.find(e=>e.color==D.GOLD.toUpperCase()&&e.handicapped)),v(Zr,e.find(e=>e.color==D.SILVER.toUpperCase())),v(H,e.find(e=>e.color==D.SILVER.toUpperCase()&&e.handicapped)),v(Qr,e.find(e=>e.color==D.PURPLE.toUpperCase())),v($r,e.find(e=>e.color==D.BLUE.toUpperCase()&&e.level==1)),v(ei,e.find(e=>e.color==D.RED.toUpperCase()&&e.level==1)),v(ti,e.find(e=>e.color==D.GREEN.toUpperCase()&&e.level==1)),v(ni,e.find(e=>e.color==D.BLUE.toUpperCase()&&e.level==2&&e.variant?.first==1)),v(ri,e.find(e=>e.color==D.RED.toUpperCase()&&e.level==2&&e.variant?.first==1)),v(ii,e.find(e=>e.color==D.GREEN.toUpperCase()&&e.level==2&&e.variant?.first==1)),v(ai,e.find(e=>e.color==D.BLUE.toUpperCase()&&e.level==2&&e.variant?.first==2)),v(oi,e.find(e=>e.color==D.RED.toUpperCase()&&e.level==2&&e.variant?.first==2)),v(si,e.find(e=>e.color==D.GREEN.toUpperCase()&&e.level==2&&e.variant?.first==2)),v(ci,e.find(e=>e.color==D.BLUE.toUpperCase()&&e.level==3&&e.variant?.first==1)),v(li,e.find(e=>e.color==D.RED.toUpperCase()&&e.level==3&&e.variant?.first==1)),v(ui,e.find(e=>e.color==D.GREEN.toUpperCase()&&e.level==3&&e.variant?.first==1)),v(di,e.find(e=>e.color==D.BLUE.toUpperCase()&&e.level==3&&e.variant?.first==2)),v(fi,e.find(e=>e.color==D.RED.toUpperCase()&&e.level==3&&e.variant?.first==2)),v(pi,e.find(e=>e.color==D.GREEN.toUpperCase()&&e.level==3&&e.variant?.first==2)),v(P,e.filter(e=>e.extra).sort((e,t)=>(e.variant?.first??0)-(t.variant?.first??0))),v(xr,m(P).map(()=>void 0)),v(Sr,m(P).map(()=>void 0)),v(Cr,m(P).map(()=>void 0)),v(wr,m(P).map(()=>!1)),ie().then(()=>{v(Sr,m(xr).map(e=>e?.getContext(`2d`)??void 0))}),m(P).forEach((e,t)=>{Z(`Extra${t+1}`).then(e=>{ae(Cr,m(Cr)[t]=e),ae(wr,m(wr)[t]=!0),v(wr,[...m(wr)])})}),(m(Dr)||m(j)&&m(Or))&&Q(m(bn),m(xn),m(j)&&m(Xr)?m(Xr):m(Yr),m(j)&&m(Xr)?m(Cn):m(Sn)),(m(kr)||m(j)&&m(H))&&Q(m(wn),m(Tn),m(j)&&m(H)?m(H):m(Zr),m(j)&&m(H)?m(Cn):m(En)),m(jr)&&Q(m(Dn),m(On),m(Qr),m(kn)),m(Mr)&&Q(m(An),m(jn),m($r),m(Mn)),m(Nr)&&Q(m(Nn),m(Pn),m(ei),m(Fn)),m(Pr)&&Q(m(In),m(Ln),m(ti),m(Rn)),m(Fr)&&Q(m(zn),m(Bn),m(ni),m(Vn)),m(Ir)&&Q(m(Gn),m(Kn),m(ri),m(qn)),m(Lr)&&Q(m(Zn),m(Qn),m(ii),m($n)),m(Rr)&&Q(m(Hn),m(Un),m(ai),m(Wn)),m(zr)&&Q(m(Jn),m(Yn),m(oi),m(Xn)),m(Br)&&Q(m(er),m(tr),m(si),m(nr)),m(Vr)&&Q(m(rr),m(ir),m(ci),m(ar)),m(Hr)&&Q(m(lr),m(ur),m(li),m(dr)),m(Ur)&&Q(m(hr),m(gr),m(ui),m(_r)),m(Wr)&&Q(m(or),m(sr),m(di),m(cr)),m(Gr)&&Q(m(fr),m(pr),m(fi),m(mr)),m(Kr)&&Q(m(vr),m(yr),m(pi),m(br)))}),Z(`BlueIA`).then(e=>{v(Mn,e),v(Mr,!0)}),Z(`BlueIIA`).then(e=>{v(Vn,e),v(Fr,!0)}),Z(`BlueIIB`).then(e=>{v(Wn,e),v(Rr,!0)}),Z(`BlueIIIA`).then(e=>{v(ar,e),v(Vr,!0)}),Z(`BlueIIIB`).then(e=>{v(cr,e),v(Wr,!0)}),Z(`Gold`).then(e=>{v(Sn,e),v(Dr,!0)}),Z(`GreenIA`).then(e=>{v(Rn,e),v(Pr,!0)}),Z(`GreenIIA`).then(e=>{v($n,e),v(Lr,!0)}),Z(`GreenIIB`).then(e=>{v(nr,e),v(Br,!0)}),Z(`GreenIIIA`).then(e=>{v(_r,e),v(Ur,!0)}),Z(`GreenIIIB`).then(e=>{v(br,e),v(Kr,!0)}),Z(`Handicap`).then(e=>{v(Cn,e),m(H)==null?v(Or,!0):v(Ar,!0)}),Z(`RedIA`).then(e=>{v(Fn,e),v(Nr,!0)}),Z(`RedIIA`).then(e=>{v(qn,e),v(Ir,!0)}),Z(`RedIIB`).then(e=>{v(Xn,e),v(zr,!0)}),Z(`RedIIIA`).then(e=>{v(dr,e),v(Hr,!0)}),Z(`RedIIIB`).then(e=>{v(mr,e),v(Gr,!0)}),Z(`Silver`).then(e=>{v(En,e),v(kr,!0)}),Z(`Ultimate`).then(e=>{v(kn,e),v(jr,!0)})});function Yi(){m(I)&&v(s,!0)}function Xi(){m(I)&&v(s,!1)}function Zi(){m(I)||v(s,!0)}function Qi(){m(I)||v(s,!1)}function $i(){v(s,!1),v(I,!m(I))}function ea(){v(s,!1),v(I,!m(I))}function ta(){m(L)&&v(b,!0)}function na(){m(L)&&v(b,!1)}function ra(){m(L)||v(b,!0)}function ia(){m(L)||v(b,!1)}function aa(){v(b,!1),v(L,!m(L))}function oa(){v(b,!1),v(L,!m(L))}function sa(){m(R)&&v(me,!0)}function ca(){m(R)&&v(me,!1)}function la(){m(R)||v(me,!0)}function ua(){m(R)||v(me,!1)}function da(){v(me,!1),v(R,!m(R))}function fa(){v(me,!1),v(R,!m(R))}function pa(){m(z)&&v(O,!0)}function ma(){m(z)&&v(O,!1)}function ha(){m(z)||v(O,!0)}function ga(){m(z)||v(O,!1)}function _a(){v(O,!1),v(z,!m(z))}function va(){v(O,!1),v(z,!m(z))}function ya(){m(B)&&v(k,!0)}function ba(){m(B)&&v(k,!1)}function xa(){m(B)||v(k,!0)}function Sa(){m(B)||v(k,!1)}function Ca(){v(k,!1),v(B,!m(B))}function wa(){v(k,!1),v(B,!m(B))}function Ta(){m(V)&&v(A,!0)}function Ea(){m(V)&&v(A,!1)}function Da(){m(V)||v(A,!0)}function Oa(){m(V)||v(A,!1)}function ka(){v(A,!1),v(V,!m(V))}function Aa(){v(A,!1),v(V,!m(V))}let ja=0;function Ma(){ja++,ja>=10&&v(un,!1)}x(()=>{},()=>{v(s,!1)}),x(()=>{},()=>{v(b,!1)}),x(()=>{},()=>{v(me,!1)}),x(()=>{},()=>{v(O,!1)}),x(()=>{},()=>{v(k,!1)}),x(()=>{},()=>{v(A,!1)}),x(()=>{},()=>{v(j,!1)}),x(()=>(m(U),m(W),m(G),m(K),m(bi),m(q),m(xi),m(J),m(Si),m(Y),m(Ci),m(X),m(zi),m(j),m(Dr),m(Or),m(kr),m(Ar),m(jr),m(Mr),m(Nr),m(Pr),m(Fr),m(Ir),m(Lr),m(Rr),m(zr),m(Br),m(Vr),m(Hr),m(Ur),m(Wr),m(Gr),m(Kr),m(ai),m(ni),m(oi),m(ri),m(si),m(ii),m(di),m(ci),m(fi),m(li),m(pi),m(ui),m(F),m(bn),m(xn),m(Xr),m(Yr),m(Cn),m(Sn),m(wn),m(Tn),m(H),m(Zr),m(En),m(Dn),m(On),m(Qr),m(kn),m(An),m(jn),m($r),m(Mn),m(Nn),m(Pn),m(ei),m(Fn),m(In),m(Ln),m(ti),m(Rn),m(zn),m(Bn),m(Vn),m(Gn),m(Kn),m(qn),m(Zn),m(Qn),m($n),m(Hn),m(Un),m(Wn),m(Jn),m(Yn),m(Xn),m(er),m(tr),m(nr),m(rr),m(ir),m(ar),m(lr),m(ur),m(dr),m(hr),m(gr),m(_r),m(or),m(sr),m(cr),m(fr),m(pr),m(mr),m(vr),m(yr),m(br),m(P),m(xr),m(Sr),m(Cr),m(wr)),()=>{m(U),m(W),m(G),m(K),m(bi),m(q),m(xi),m(J),m(Si),m(Y),m(Ci),m(X),m(zi),m(j),m(Dr),m(Or),m(kr),m(Ar),m(jr),m(Mr),m(Nr),m(Pr),m(Fr),m(Ir),m(Lr),m(Rr),m(zr),m(Br),m(Vr),m(Hr),m(Ur),m(Wr),m(Gr),m(Kr);let e=m(W)?!0:m(U)?!1:null,t=m(K)?!0:m(G)?!1:null,n=m(q)?!0:m(bi)?!1:null,r=m(J)?!0:m(xi)?!1:null,i=m(Y)?!0:m(Si)?!1:null,a=m(X)?!0:m(Ci)?!1:null,o={};o[E.INITIATIVE]=0,o[E.ATTACK]=0,o[E.DEFENSE]=0,o[E.AREA]=0,o[E.RANGE]=0,o[E.MOVEMENT]=0;let s=e=>{e?.item&&(o[e.item]+=1)};e===!0&&s(m(ai)),e===!1&&s(m(ni)),t===!0&&s(m(oi)),t===!1&&s(m(ri)),n===!0&&s(m(si)),n===!1&&s(m(ii)),r===!0&&s(m(di)),r===!1&&s(m(ci)),i===!0&&s(m(fi)),i===!1&&s(m(li)),a===!0&&s(m(pi)),a===!1&&s(m(ui)),v(mi,o[E.INITIATIVE]),v(hi,o[E.ATTACK]),v(gi,o[E.DEFENSE]),v(_i,o[E.AREA]),v(vi,o[E.RANGE]),v(yi,o[E.MOVEMENT]),m(F)&&(m(Dr)||m(Or))&&Q(m(bn),m(xn),m(j)&&m(Xr)?m(Xr):m(Yr),m(j)&&m(Xr)?m(Cn):m(Sn)),m(F)&&(m(kr)||m(Ar))&&Q(m(wn),m(Tn),m(j)&&m(H)?m(H):m(Zr),m(j)&&m(H)?m(Cn):m(En)),m(F)&&m(jr)&&Q(m(Dn),m(On),m(Qr),m(kn)),m(F)&&m(Mr)&&Q(m(An),m(jn),m($r),m(Mn)),m(F)&&m(Nr)&&Q(m(Nn),m(Pn),m(ei),m(Fn)),m(F)&&m(Pr)&&Q(m(In),m(Ln),m(ti),m(Rn)),m(F)&&m(Fr)&&Q(m(zn),m(Bn),m(ni),m(Vn)),m(F)&&m(Ir)&&Q(m(Gn),m(Kn),m(ri),m(qn)),m(F)&&m(Lr)&&Q(m(Zn),m(Qn),m(ii),m($n)),m(F)&&m(Rr)&&Q(m(Hn),m(Un),m(ai),m(Wn)),m(F)&&m(zr)&&Q(m(Jn),m(Yn),m(oi),m(Xn)),m(F)&&m(Br)&&Q(m(er),m(tr),m(si),m(nr)),m(F)&&m(Vr)&&Q(m(rr),m(ir),m(ci),m(ar)),m(F)&&m(Hr)&&Q(m(lr),m(ur),m(li),m(dr)),m(F)&&m(Ur)&&Q(m(hr),m(gr),m(ui),m(_r)),m(F)&&m(Wr)&&Q(m(or),m(sr),m(di),m(cr)),m(F)&&m(Gr)&&Q(m(fr),m(pr),m(fi),m(mr)),m(F)&&m(Kr)&&Q(m(vr),m(yr),m(pi),m(br));for(let e=0;e<m(P).length;e++){let t=m(xr)[e],n=m(Sr)[e],r=m(Cr)[e];m(F)&&m(wr)[e]&&t&&n&&r&&Q(t,n,m(P)[e],r)}}),x(()=>m(zi),()=>{localStorage.setItem(Tr,`${m(zi)}`)}),x(()=>(m(Er),m(I),m(L),m(R),m(z),m(B),m(V),m(U),m(W),m(G),m(K),m(bi),m(q),m(xi),m(J),m(Si),m(Y),m(Ci),m(X)),()=>{if(m(Er)){let e={blueIIalt:m(I),redIIalt:m(L),greenIIalt:m(R),blueIIIalt:m(z),redIIIalt:m(B),greenIIIalt:m(V),blueIIaltChecked:m(U),blueIImainChecked:m(W),redIIaltChecked:m(G),redIImainChecked:m(K),greenIIaltChecked:m(bi),greenIImainChecked:m(q),blueIIIaltChecked:m(xi),blueIIImainChecked:m(J),redIIIaltChecked:m(Si),redIIImainChecked:m(Y),greenIIIaltChecked:m(Ci),greenIIImainChecked:m(X)};localStorage.setItem(Li(),JSON.stringify(e))}}),x(()=>{},()=>{v(un,!0)}),x(()=>(l(yn()),De),()=>{v(dn,yn()?De.slice(0,4):De)}),x(()=>(l(yn()),l(N()),Ae),()=>{v(Vi,yn()?ke[N()]:Ae[N()])}),x(()=>m(Vi),()=>{v(Hi,m(Vi)?`${m(Vi).name} ${m(Vi).title}`:``)}),x(()=>l(N()),()=>{v(qr,N()===`gydion`)}),x(()=>(m(I),m(L),m(R)),()=>{v(Jr,m(I)||m(L)||m(R))}),ce(),de();var Na=ln(),Pa=h(Na),Fa=h(Pa),Ia=h(Fa),La=h(Ia);he(La,{get src(){return m(Ki)},class:`rounded-lg sm:rounded-xl lg:rounded-3xl`});var Ra=S(La,2),za=h(Ra,!0);a(Ra);var Ba=S(Ra,2),Va=h(Ba,!0);a(Ba);var Ha=S(Ba,2),Ua=h(Ha,!0);a(Ha);var Wa=S(Ha,2),Ga=h(Wa,!0);a(Wa);var Ka=S(Wa,2),qa=h(Ka,!0);a(Ka),a(Ia),a(Fa);var Ja=S(Fa,2);o(Ja,1,()=>m(dn),c,(e,t,i)=>{let s=oe(()=>(m(Vi),f(()=>Ui(m(Vi)?.stats?.[i]))));var u=Ut(),d=se(u),ee=h(d),te=h(ee),ie=h(te);{let e=oe(()=>(m(t),f(()=>Ji(m(t)))));he(ie,{get src(){return m(e)},class:`absolute w-2 xs:w-2.5 sm:w-3.75 lg:w-5 z-30 -top-0.5 sm:-top-0.75 lg:-top-1.25 xs:left-0.5 sm:left-0.75 lg:left-1`})}o(S(ie,4),0,()=>Array(8),c,(e,t,i)=>{var a=Ht(),o=S(se(a),2),c=e=>{var t=zt();y(()=>r(t,1,`z-40 float-left w-[5.6px] xs:w-[7px] sm:w-[12px] lg:w-5 h-1 xs:h-1.5 sm:h-2 lg:h-2.5 rounded-sm sm:rounded lg:rounded-md bg-${N()??``}`,`svelte-116f7tl`)),n(e,t)},u=e=>{var t=Bt();y(()=>r(t,1,`z-40 float-left w-[5.6px] xs:w-[7px] sm:w-[12px] lg:w-5 h-1 xs:h-1.5 sm:h-2 lg:h-2.5 rounded-sm sm:rounded lg:rounded-md bg-${N()??``} opacity-50`,`svelte-116f7tl`)),n(e,t)},d=e=>{n(e,Vt())};p(o,e=>{l(m(s)),f(()=>m(s).min>i)?e(c):(l(m(s)),f(()=>m(s).max>i)?e(u,1):e(d,-1))}),n(e,a)}),a(te),a(ee),a(d),_e(S(d,2),{get triggeredBy(){return`#${m(t)??``}`},placement:`top`,class:`z-50`,children:(e,r)=>{ne();var i=re();y(e=>pe(i,e),[()=>(m(t),f(()=>m(t).charAt(0).toUpperCase()+m(t).slice(1)))]),n(e,i)},$$slots:{default:!0}}),y(()=>C(d,`id`,m(t))),n(e,u)});var Ya=S(Ja,2),Xa=h(Ya);g(h(Xa),e=>v(bn,e),()=>m(bn)),a(Xa),a(Ya);var Za=S(Ya,2),Qa=h(Za);g(h(Qa),e=>v(wn,e),()=>m(wn)),a(Qa),a(Za);var $a=S(Za,2),eo=h($a);g(h(eo),e=>v(Dn,e),()=>m(Dn)),a(eo),a($a);var to=S($a,2),no=e=>{var r=Wt(),i=se(r),o=h(i),s=h(o);a(o),a(i);var c=S(i,2),l=h(c),u=h(l);a(l),a(c);var d=S(c,2),p=h(d),ee=h(p);a(p),a(d),y((e,t,n)=>{C(s,`src`,e),C(u,`src`,t),C(ee,`src`,n)},[()=>f(()=>$(`GoldI`)),()=>f(()=>$(`GoldII`)),()=>f(()=>$(`GoldIII`))]),t(1,i,()=>w,()=>M),t(2,i,()=>w,()=>M),t(1,c,()=>w,()=>M),t(2,c,()=>w,()=>M),t(1,d,()=>w,()=>M),t(2,d,()=>w,()=>M),n(e,r)};p(to,e=>{m(qr)&&e(no)});var ro=S(to,2),io=h(ro);g(h(io),e=>v(An,e),()=>m(An)),a(io),a(ro);var ao=S(ro,2),oo=h(ao);g(h(oo),e=>v(Nn,e),()=>m(Nn)),a(oo),a(ao);var so=S(ao,2),co=h(so);g(h(co),e=>v(In,e),()=>m(In)),a(co),a(so);var lo=S(so,2),uo=e=>{var r=Gt(),i=se(r),o=h(i),s=h(o);a(o),a(i);var c=S(i,2),l=h(c),u=h(l);a(l),a(c);var d=S(c,2),p=h(d),ee=h(p);a(p),a(d),y((e,t,n)=>{C(s,`src`,e),C(u,`src`,t),C(ee,`src`,n)},[()=>f(()=>$(`BlueIA`)),()=>f(()=>$(`RedIA`)),()=>f(()=>$(`GreenIA`))]),t(1,i,()=>w,()=>M),t(2,i,()=>w,()=>M),t(1,c,()=>w,()=>M),t(2,c,()=>w,()=>M),t(1,d,()=>w,()=>M),t(2,d,()=>w,()=>M),n(e,r)};p(lo,e=>{m(qr)&&e(uo)});var fo=S(lo,2),po=h(fo),mo=h(po);g(mo,e=>v(Hn,e),()=>m(Hn)),T(S(mo,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(U)},set checked(e){v(U,e)},$$events:{change:wi},$$legacy:!0}),a(po);var ho=S(po,2),go=h(ho);g(go,e=>v(zn,e),()=>m(zn)),T(S(go,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(W)},set checked(e){v(W,e)},$$events:{change:Ti},$$legacy:!0}),a(ho),a(fo);var _o=S(fo,2),vo=h(_o),yo=h(vo);g(yo,e=>v(Jn,e),()=>m(Jn)),T(S(yo,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(G)},set checked(e){v(G,e)},$$events:{change:Ei},$$legacy:!0}),a(vo);var bo=S(vo,2),xo=h(bo);g(xo,e=>v(Gn,e),()=>m(Gn)),T(S(xo,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(K)},set checked(e){v(K,e)},$$events:{change:Di},$$legacy:!0}),a(bo),a(_o);var So=S(_o,2),Co=h(So),wo=h(Co);g(wo,e=>v(er,e),()=>m(er)),T(S(wo,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(bi)},set checked(e){v(bi,e)},$$events:{change:Oi},$$legacy:!0}),a(Co);var To=S(Co,2),Eo=h(To);g(Eo,e=>v(Zn,e),()=>m(Zn)),T(S(Eo,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(q)},set checked(e){v(q,e)},$$events:{change:ki},$$legacy:!0}),a(To),a(So);var Do=S(So,2),Oo=e=>{var r=$t(),i=se(r);d(h(i),()=>m(I),e=>{var r=Kt(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>(m(I),f(()=>$(m(I)?`BlueIIB`:`BlueIIA`)))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)}),a(i);var o=S(i,2);d(h(o),()=>m(L),e=>{var r=qt(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>(m(L),f(()=>$(m(L)?`RedIIB`:`RedIIA`)))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)}),a(o);var s=S(o,2);d(h(s),()=>m(R),e=>{var r=Jt(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>(m(R),f(()=>$(m(R)?`GreenIIB`:`GreenIIA`)))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)}),a(s);var c=S(s,2),l=e=>{var r=Qt(),i=h(r),o=h(i),s=e=>{var r=Yt(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>f(()=>$(`BlueIIB2`))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)};p(o,e=>{m(I)&&e(s)}),a(i);var c=S(i,2),l=h(c),u=e=>{var r=Xt(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>f(()=>$(`RedIIB2`))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)};p(l,e=>{m(L)&&e(u)}),a(c);var d=S(c,2),ee=h(d),te=e=>{var r=Zt(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>f(()=>$(`GreenIIB2`))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)};p(ee,e=>{m(R)&&e(te)}),a(d),a(r),t(3,r,()=>ve,()=>fn),n(e,r)};p(c,e=>{m(Jr)&&e(l)}),t(1,i,()=>w,()=>M),t(2,i,()=>w,()=>M),t(1,o,()=>w,()=>M),t(2,o,()=>w,()=>M),t(1,s,()=>w,()=>M),t(2,s,()=>w,()=>M),n(e,r)};p(Do,e=>{m(qr)&&e(Oo)});var ko=S(Do,2),Ao=h(ko),jo=h(Ao);g(jo,e=>v(or,e),()=>m(or)),T(S(jo,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(xi)},set checked(e){v(xi,e)},$$events:{change:Ai},$$legacy:!0}),a(Ao);var Mo=S(Ao,2),No=h(Mo);g(No,e=>v(rr,e),()=>m(rr)),T(S(No,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(J)},set checked(e){v(J,e)},$$events:{change:ji},$$legacy:!0}),a(Mo),a(ko);var Po=S(ko,2),Fo=h(Po),Io=h(Fo);g(Io,e=>v(fr,e),()=>m(fr)),T(S(Io,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(Si)},set checked(e){v(Si,e)},$$events:{change:Mi},$$legacy:!0}),a(Fo);var Lo=S(Fo,2),Ro=h(Lo);g(Ro,e=>v(lr,e),()=>m(lr)),T(S(Ro,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(Y)},set checked(e){v(Y,e)},$$events:{change:Ni},$$legacy:!0}),a(Lo),a(Po);var zo=S(Po,2),Bo=h(zo),Vo=h(Bo);g(Vo,e=>v(vr,e),()=>m(vr)),T(S(Vo,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(Ci)},set checked(e){v(Ci,e)},$$events:{change:Pi},$$legacy:!0}),a(Bo);var Ho=S(Bo,2),Uo=h(Ho);g(Uo,e=>v(hr,e),()=>m(hr)),T(S(Uo,2),{class:`absolute top-[3px] xs:top-[3.9px] sm:top-[6.5px] lg:top-[10px] right-[4px] xs:right-[4.6px] sm:right-[8px] lg:right-[12px] w-2 xs:w-2.5 sm:w-4 lg:w-6 h-2 xs:h-2.5 sm:h-4 lg:h-6 rounded-full`,get checked(){return m(X)},set checked(e){v(X,e)},$$events:{change:Fi},$$legacy:!0}),a(Ho),a(zo);var Wo=S(zo,2),Go=e=>{var r=rn(),i=se(r);d(h(i),()=>m(z),e=>{var r=en(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>(m(z),f(()=>$(m(z)?`BlueIIIB`:`BlueIIIA`)))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)}),a(i);var o=S(i,2);d(h(o),()=>m(B),e=>{var r=tn(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>(m(B),f(()=>$(m(B)?`RedIIIB`:`RedIIIA`)))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)}),a(o);var s=S(o,2);d(h(s),()=>m(V),e=>{var r=nn(),i=h(r);a(r),y(e=>C(i,`src`,e),[()=>(m(V),f(()=>$(m(V)?`GreenIIIB`:`GreenIIIA`)))]),t(1,r,()=>w,()=>mn),t(2,r,()=>w,()=>pn),n(e,r)}),a(s);var c=S(s,4),l=h(c),u=h(l);a(l),a(c),ne(2),y(e=>C(u,`src`,e),[()=>f(()=>$(`Ultimate`))]),t(1,i,()=>w,()=>M),t(2,i,()=>w,()=>M),t(1,o,()=>w,()=>M),t(2,o,()=>w,()=>M),t(1,s,()=>w,()=>M),t(2,s,()=>w,()=>M),t(1,c,()=>w,()=>M),t(2,c,()=>w,()=>M),n(e,r)};p(Wo,e=>{m(qr)&&e(Go)});var Ko=S(Wo,2),qo=e=>{var t=on();o(t,5,()=>m(P),c,(e,t,r)=>{var i=an(),o=h(i);g(h(o),(e,t)=>ae(xr,m(xr)[t]=e),e=>m(xr)?.[e],()=>[r]),a(o),a(i),n(e,i)}),a(t),n(e,t)};p(Ko,e=>{m(P),f(()=>m(P).length>0)&&e(qo)});var Jo=S(Ko,2),Yo=h(Jo);T(Yo,{get disabled(){return m(un)},get checked(){return m(zi)},set checked(e){v(zi,e)},children:(e,t)=>{var r=sn();y(e=>ee(r,`color: ${e??``}`),[()=>(m(un),f(()=>Bi(m(un))))]),n(e,r)},$$slots:{default:!0},$$legacy:!0}),_e(S(Yo,2),{triggeredBy:`#showNumbers`,placement:`bottom`,class:`z-50`,children:(e,t)=>{ne(),n(e,re(`Disabled by the developer's request`))},$$slots:{default:!0}}),a(Jo);var Xo=S(Jo,2);T(h(Xo),{get checked(){return m(j)},set checked(e){v(j,e)},children:(e,t)=>{n(e,cn())},$$slots:{default:!0},$$legacy:!0}),a(Xo),a(Pa),ne(2),a(Na),y(()=>{pe(za,m(Hi)),pe(Va,m(Hi)),pe(Ua,m(Hi)),pe(Ga,m(Hi)),pe(qa,m(Hi)),r(po,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(I)?`mainCardII`:m(s)?`downCardII`:`altCardII`}`,`svelte-116f7tl`),r(ho,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(I)?m(s)?`downCardII`:`altCardII`:`mainCardII`}`,`svelte-116f7tl`),r(vo,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(L)?`mainCardII`:m(b)?`downCardII`:`altCardII`}`,`svelte-116f7tl`),r(bo,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(L)?m(b)?`downCardII`:`altCardII`:`mainCardII`}`,`svelte-116f7tl`),r(Co,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(R)?`mainCardII`:m(me)?`downCardII`:`altCardII`}`,`svelte-116f7tl`),r(To,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(R)?m(me)?`downCardII`:`altCardII`:`mainCardII`}`,`svelte-116f7tl`),r(Ao,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(z)?`mainCardIII`:m(O)?`downCardIII`:`altCardIII`}`,`svelte-116f7tl`),r(Mo,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(z)?m(O)?`downCardIII`:`altCardIII`:`mainCardIII`}`,`svelte-116f7tl`),r(Fo,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(B)?`mainCardIII`:m(k)?`downCardIII`:`altCardIII`}`,`svelte-116f7tl`),r(Lo,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(B)?m(k)?`downCardIII`:`altCardIII`:`mainCardIII`}`,`svelte-116f7tl`),r(Bo,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(V)?`mainCardIII`:m(A)?`downCardIII`:`altCardIII`}`,`svelte-116f7tl`),r(Ho,1,`border border-dark-600 bg-transparent hover:bg-transparent rounded-lg sm:rounded-xl lg:rounded-3xl w-25.5 xs:w-31 sm:w-51.5 lg:w-78 left-0.25 xs:left-0.5 sm:left-0.5 lg:left-1 absolute duration-500 ${m(V)?m(A)?`downCardIII`:`altCardIII`:`mainCardIII`}`,`svelte-116f7tl`)}),u(`click`,Ia,Ma),u(`click`,mo,ea),u(`pointerleave`,mo,Qi),u(`pointerenter`,mo,Zi),u(`click`,go,$i),u(`pointerleave`,go,Xi),u(`pointerenter`,go,Yi),u(`click`,yo,oa),u(`pointerleave`,yo,ia),u(`pointerenter`,yo,ra),u(`click`,xo,aa),u(`pointerleave`,xo,na),u(`pointerenter`,xo,ta),u(`click`,wo,fa),u(`pointerleave`,wo,ua),u(`pointerenter`,wo,la),u(`click`,Eo,da),u(`pointerleave`,Eo,ca),u(`pointerenter`,Eo,sa),u(`click`,jo,va),u(`pointerleave`,jo,ga),u(`pointerenter`,jo,ha),u(`click`,No,_a),u(`pointerleave`,No,ma),u(`pointerenter`,No,pa),u(`click`,Io,wa),u(`pointerleave`,Io,Sa),u(`pointerenter`,Io,xa),u(`click`,Ro,Ca),u(`pointerleave`,Ro,ba),u(`pointerenter`,Ro,ya),u(`click`,Vo,Aa),u(`pointerleave`,Vo,Oa),u(`pointerenter`,Vo,Da),u(`click`,Uo,ka),u(`pointerleave`,Uo,Ea),u(`pointerenter`,Uo,Ta),n(e,Na),fe()}function k(e,t){throw new me(e,t)}var A=s(`<meta name="description"/>`);function j(t,r){te(r,!1);let a=le(r,`data`,8)().url.substring(1),o=_(``),s=new URLSearchParams(window.location.search).get(`printing`)!==`old`;x(()=>k,()=>{if(s&&!(a in ke))throw k(404)}),x(()=>k,()=>{if(!s&&!(a in Ae))throw k(404)}),x(()=>Ae,()=>{v(o,s?ke[a].name:Ae[a].name)}),ce(),de(),i(`qu11qx`,t=>{var r=A();y(()=>C(r,`content`,`Guards of Atlantis II card collection for ${m(o)??``}.`)),e(()=>{b.title=m(o)??``}),n(t,r)}),O(t,{get heroName(){return a},get useNewPrinting(){return s}}),fe()}export{j as component};