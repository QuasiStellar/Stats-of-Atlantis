...
of all enemy heroes, except this attacker.`,color:"BLUE",level:2,variant:{first:1,second:2},initiative:10,primaryAction:"DEFENSE",primaryValue:6,secondaryMovement:3,item:"DEFENSE"},{name:"Rogue Wave",description:`Target a unit in range.
...
than 1 space with a movement action.`,color:"BLUE",level:2,variant:{first:2,second:2},initiative:10,primaryAction:"MOVEMENT",secondaryDefense:6,item:"ATTACK"},{name:"Raging Stream",description:`Target a unit adjacent to you. Before the
attack: Up to 1 enemy hero in any of the
...
1 space with a movement action.`,color:"BLUE",level:3,variant:{first:2,second:2},initiative:10,primaryAction:"MOVEMENT",modifier:"AREA",modifierValue:1,secondaryDefense:6,item:"ATTACK"},{name:"Tidal Blast",description:`Target a unit in range.
...
>>Target a hero adjacent to you.`,color:"RED",level:2,variant:{first:2,second:2},initiative:8,primaryAction:"ATTACK",primaryValue:4,modifier:"RANGE",modifierValue:3,secondaryMovement:4,secondaryDefense:6,item:"INITIATIVE"},{name:"Vantage Point",description:`Ignore obstacles. If a hero in play has
...
>>Target a hero in range with
>a ::marker_bounty:: Bounty marker.
>>Target a hero adjacent to you.`,color:"RED",level:3,variant:{first:2,second:2},initiative:9,primaryAction:"ATTACK",primaryValue:5,modifier:"RANGE",modifierValue:3,secondaryMovement:4,secondaryDefense:7,item:"MOVEMENT"},{name:"High Ground",description:`Ignore obstacles. If a hero in play has
...
in the discard, target a unit in range.`,color:"RED",level:3,variant:{first:2,second:2},initiative:8,primaryAction:"ATTACK",primaryValue:4,modifier:"RANGE",modifierValue:2,secondaryMovement:4,secondaryDefense:6,item:"AREA"},{name:"Master Skald",description:`A friendly hero in range gains 2 coin2;
if any hero was defeated this round,
...
you may move that minion up to 2 spaces.`,color:"GREEN",level:2,variant:{first:2,second:2},initiative:3,primaryAction:"SKILL",secondaryMovement:2,secondaryDefense:3,item:"DEFENSE"},{name:"Broadside",description:`A enemy hero in radius, adjacent to
another enemy unit and not adjacent
to you, discards a card, if able.
...
>more cards in the discard.`,color:"RED",level:1,initiative:9,primaryAction:"ATTACK",primaryValue:4,modifier:"RANGE",modifierValue:2,secondaryMovement:5,secondaryDefense:4},{name:"Dark Ritual",description:`If there are 2 or more empty spawn points
...
**End of turn:** Remove all Glitch tokens.`,color:"SILVER",initiative:1,primaryAction:"DEFENSE_SKILL",modifier:"AREA",modifierValue:4},{name:"Alternative Timelines",description:`You may play two cards each turn;
...
radius, you may retrieve a discarded card.`,color:"GREEN",level:2,variant:{first:1,second:2},initiative:4,primaryAction:"SKILL",modifier:"RANGE",modifierValue:4,secondaryMovement:2,secondaryDefense:4,item:"INITIATIVE"},{name:"Form Up!",description:`Move a friendly unit in range 1 space
...
push that hero 3 spaces, ignoring obstacles.`,color:"RED",level:2,variant:{first:2,second:2},initiative:8,primaryAction:"ATTACK",primaryValue:6,secondaryMovement:4,secondaryDefense:7,item:"INITIATIVE"},{name:"Light Pilum",description:`An enemy hero in range discards a card,
...
two discarded cards.`,color:"GREEN",level:3,variant:{first:1,second:2},initiative:4,primaryAction:"SKILL",modifier:"RANGE",modifierValue:4,secondaryMovement:2,secondaryDefense:4,item:"INITIATIVE"},{name:"Testudo!",description:`Move a friendly unit in range 1 space
to a space closer to you.
...
If able, move 3 spaces in a straight line.`,color:"GOLD",initiative:13,primaryAction:"ATTACK",secondaryMovement:2,secondaryDefense:1},{name:"Fight or Flight",description:`Target a hero adjacent to you.
If the target is not defeated, After the attack:
...
You may move 1 space.`,color:"GREEN",level:3,variant:{first:1,second:2},initiative:1,primaryAction:"SKILL",secondaryMovement:2,secondaryDefense:2,item:"DEFENSE"},{name:"That Way!",description:`A friendly hero in radius chooses a distance
...
---
::tiebreaker_orange:: Target a hero in range.`,color:"GOLD",initiative:11,primaryAction:"ATTACK",primaryValue:2,modifier:"RANGE",modifierValue:3,secondaryMovement:1,secondaryDefense:2},{name:"Unreliable Jolt",description:`::tiebreaker_blue::: Target a hero adjacent to you.
---
::tiebreaker_orange:: Target a hero in range not adjacent to you.`,color:"GOLD",handicapped:!0,initiative:10,primaryAction:"ATTACK",primaryValue:1,modifier:"RANGE",modifierValue:2,secondaryMovement:1,secondaryDefense:1},{name:"Equilibrium",description:`**This round:** Each time you perform or repeat
...
line between that enemy hero and their target.`,color:"SILVER",initiative:12,primaryAction:"SKILL",modifier:"AREA",modifierValue:3,secondaryMovement:1},{name:"Flurry of blows",description:`Each time after you perform an attack action,
...
it to your dashboard as a permanent item.`,color:"GREEN",level:3,variant:{first:2,second:2},initiative:1,primaryAction:"SKILL",secondaryMovement:2,secondaryDefense:3,item:"RANGE"}],po=[{name:"Watch How I Soar",description:`**Choose one —**
...
>target; if you do, gain +1 ::gold_attack:: Attack.`,color:"GOLD",initiative:11,primaryAction:"ATTACK",primaryValue:4,primaryValueSign:"PLUS",modifier:"AREA",modifierValue:4,secondaryMovement:1,secondaryDefense:3},{name:"Shallow Graves",description:`Target a unit adjacent to you.
Before the attack: **Choose up to two times —**
>>Move a ::token_zombie:: Zombie token in radius 1 space.
>>Remove a Zombie token adjacent to the
>target; if you do, gain +1 ::gold_attack:: Attack.`,color:"GOLD",handicapped:!0,initiative:10,primaryAction:"ATTACK",primaryValue:3,primaryValueSign:"PLUS",modifier:"AREA",modifierValue:4,secondaryMovement:1,secondaryDefense:1},{name:"Awaken!",description:`Place up to 4 ::token_zombie:: Zombie tokens into
...
to terrain, or to a ::token_rock:: Rock token,
discards a card, or is defeated.`,color:"RED",level:2,variant:{first:1,second:2},initiative:7,primaryAction:"SKILL",modifier:"AREA",modifierValue:4,secondaryMovement:3,secondaryDefense:7,secondaryAttack:6,item:"INITIATIVE"},{name:"Stone Carapace",description:`**This round:** if you would discard a card from
...
Move another one of you up to 1 space.`,color:"BLUE",level:1,initiative:9,primaryAction:"SKILL",modifier:"RANGE",modifierValue:3,secondaryMovement:2,secondaryDefense:3},{name:"Phantom Strike",description:`Target a unit adjacent to you. After the attack:
...
in radius, you may retrieve a discarded card.`,color:"RED",level:3,variant:{first:2,second:2},initiative:10,primaryAction:"ATTACK",primaryValue:5,modifier:"RANGE",modifierValue:3,secondaryMovement:4,secondaryDefense:4,item:"MOVEMENT"},{name:"Spectacle",description:`Swap with a minion in range.
...
retrieve a discarded card.`,color:"GOLD",initiative:11,primaryAction:"ATTACK",primaryValue:4,secondaryMovement:1,secondaryDefense:1},{name:"Earn the Spurs",description:`Target a hero adjacent to you.
...
move 1 space; if they do, gain 2 coins.`,color:"SILVER",initiative:5,primaryAction:"SKILL",secondaryDefense:3},{name:"Token of Gratitude",description:`Target a unit adjacent to you. After the attack:
...
>space adjacent to you.`,color:"GREEN",level:1,initiative:4,primaryAction:"MOVEMENT",primaryValue:2,modifier:"AREA",modifierValue:2,secondaryDefense:3},{name:"Stand Guard",description:`Swap with a friendly unit in range
which is adjacent to an enemy hero,
or who has a card in the disacrd.`,color:"BLUE",level:1,initiative:9,primaryAction:"SKILL",modifier:"RANGE",modifierValue:3,secondaryMovement:2,secondaryDefense:6},{name:"Fair Share",description:`Target a unit adjacent to you. After the attack:
...
>space adjacent to that enemy hero.
>> Place an enemy minion in radius into a
>space adjacent to you.`,color:"GREEN",level:2,variant:{first:1,second:2},initiative:11,primaryAction:"MOVEMENT",primaryValue:2,modifier:"AREA",modifierValue:3,secondaryMovement:1,secondaryDefense:2,item:"ATTACK"},{name:"Opening Shots",description:`If both you and an enemy hero in radius
...
May repeat once on a different target.`,color:"RED",level:3,variant:{first:1,second:2},initiative:9,primaryAction:"ATTACK",primaryValue:6,secondaryMovement:4,secondaryDefense:7,item:"RANGE"},{name:"Paragon of Valor",description:`Target a unit adjacent to you.
After the attack: A friendly hero in radius
may retrieve a discarded card; if they do,
you may repeat once on a different target.`,color:"RED",level:3,variant:{first:2,second:2},initiative:9,primaryAction:"ATTACK",primaryValue:7,secondaryMovement:4,secondaryDefense:8,item:"DEFENSE"},{name:"Fabled Lance",description:`All of your attack actions gain the "Ranged"
subtype, target a unit in range, and count
as having a printed ::range_purple:: Range value of 2.`,color:"PURPLE",level:4,modifier:"RANGE",modifierValue:2}],Io=[{name:"Point Blank Shot",description:`Target a unit in range. After the attack:
...
After the attack: If able, you may
fast travel up to an adjacent zone.`,color:"GOLD",handicapped:!0,initiative:11,primaryAction:"ATTACK",primaryValue:1,modifier:"RANGE",modifierValue:2,secondaryMovement:1,secondaryDefense:1},{name:"Trailblazer",description:`You may fast travel, if able.
...
**This Turn:** You are immune to enemy actions.`,color:"GREEN",level:1,initiative:5,primaryAction:"SKILL",primaryValueSign:"EXCLAMATION",secondaryMovement:2},{name:"Hidden Passage",description:`If a rune is active:
...
minion in radius is defeated, gain 1 coin.`,color:"GREEN",level:3,variant:{first:2,second:2},initiative:3,primaryAction:"SKILL",modifier:"AREA",modifierValue:4,secondaryMovement:2,secondaryDefense:3,item:"INITIATIVE"}],bo=[{name:"Float like a Butterfly",description:`Swap this card with a different
...
place the new card facedown.`,color:"SILVER",initiative:5,primaryAction:"SKILL",secondaryDefense:6},{name:"Shameful Display",description:"~(You are defeated.)",color:"SILVER",handicapped:!0,initiative:5,primaryAction:"DEFENSE"},{name:"Set an Example",description:`Target a unit adjacent to you. After the attack:
...
radius to you count as obstacles for enemy units.`,color:"RED",level:3,variant:{first:2,second:2},initiative:12,primaryAction:"ATTACK",primaryValue:3,modifier:"AREA",modifierValue:1,secondaryMovement:1,secondaryDefense:2,item:"RANGE"},{name:"Chosen Champion",description:`Choose a card in the discard of a friendly
hero in radius. An enemy hero in radius
...
~(You now have a total hand size of 6 cards.)`,color:"PURPLE",level:4}],ko=[{name:"Ice Blast",description:`Target a unit adjacent to you. If the target
...
Totem tokens are immune to enemy actions.`,color:"GREEN",level:3,variant:{first:2,second:2},initiative:3,primaryAction:"SKILL",modifier:"RANGE",modifierValue:2,secondaryMovement:2,secondaryDefense:4,item:"ATTACK"}],Ro=[{name:"Blink Strike",description:`Before the attack: Move 2 spaces in a straight
line through an enemy unit; target that unit.
...
>the Turret discards a card, if able.
>>Defeat an enemy minion in range of both
>you and the Turret.`,color:"GOLD",initiative:12,primaryAction:"SKILL",modifier:"RANGE",modifierValue:2,secondaryMovement:4,secondaryDefense:1},{name:"Ramshackle Turret",description:`Move up to 3 spaces and place
...
>It counts as terrain.
>>Remove the Turret. If you do, move
>up to 3 spaces.`,color:"SILVER",initiative:5,primaryAction:"SKILL",secondaryDefense:2},{name:"Unlimited Firepower",description:`Whenever you perform an action, barrier
tokens and friendly minions count as a Turret.`,color:"PURPLE",level:4},{name:"Disruptor Jolt",description:`**This turn:** Enemy heroes in radius of the
Turret cannot perform non-basic skills.`,color:"BLUE",level:1,initiative:10,primaryAction:"SKILL",modifier:"AREA",modifierValue:3,secondaryMovement:3,secondaryDefense:3},{name:"Makeshift Minigun",description:`Target a unit in range of both you and the
Turret. After the attack: **Next turn:**
Gain +1 ::range_red:: Range if you target a hero.`,color:"RED",level:1,initiative:8,primaryAction:"ATTACK",primaryValue:3,modifier:"RANGE",modifierValue:2,secondaryMovement:4,secondaryDefense:4},{name:"Early Prototype",description:`Swap yourself, a friendly unit, or a token,
...
Gain +1 ::range_red:: Range; if you target a hero
with no cards in their hand with your
basic skill, defeat that hero, instead.`,color:"RED",level:2,variant:{first:1,second:2},initiative:9,primaryAction:"ATTACK",primaryValue:3,modifier:"RANGE",modifierValue:3,secondaryMovement:4,secondaryDefense:5,item:"DEFENSE"},{name:"Updated Design",description:`Swap yourself, a friendly unit, or a token,
in radius of the Turret, with the Turret.`,color:"GREEN",level:2,variant:{first:1,second:2},initiative:3,primaryAction:"SKILL",modifier:"AREA",modifierValue:3,secondaryMovement:3,secondaryDefense:2,item:"ATTACK"},{name:"Deployable Barrier",description:`Place up to 2 ::token_barrier:: barrier tokens in radius of
the Turret and adjacent to another barrier
token, if able. You and friendly heroes gain
+1 ::defense_silver:: Defense for each adjacent barrier token.`,color:"BLUE",level:2,variant:{first:2,second:2},initiative:10,primaryAction:"SKILL",modifier:"AREA",modifierValue:3,secondaryMovement:3,secondaryDefense:4,item:"ATTACK"},{name:"Steam Discharge",description:`Target a unit in range of both you and the
...
enemies in radius of the Turret.
**This turn and next turn:** Enemies in
radius of the Turret cannot perform skills.`,color:"BLUE",level:3,variant:{first:1,second:2},initiative:11,primaryAction:"SKILL",modifier:"AREA",modifierValue:3,secondaryMovement:3,secondaryDefense:4,item:"DEFENSE"},{name:"Supercharged Cannon",description:`Target a unit in range of both you and the
Turret. After the attack: **Next turn:**
Gain +2 ::range_red:: Range; if you target a hero
with no cards in their hand with your
basic skill, defeat that hero, instead.`,color:"RED",level:3,variant:{first:1,second:2},initiative:9,primaryAction:"ATTACK",primaryValue:4,modifier:"RANGE",modifierValue:3,secondaryMovement:4,secondaryDefense:5,item:"AREA"},{name:"Perfected Design",description:`Swap yourself, any unit, or a token,
...
hero in range of both you and the Turret
discards a card, if able.`,color:"RED",level:3,variant:{first:2,second:2},initiative:9,primaryAction:"ATTACK",primaryValue:5,modifier:"RANGE",modifierValue:3,secondaryMovement:4,secondaryDefense:6,item:"MOVEMENT"},{name:"Emergency Protocol",description:`Enemy heroes in radius of the Turret discard
a card, or are defeated. Remove the Turret.`,color:"GREEN",level:3,variant:{first:2,second:2},initiative:2,primaryAction:"SKILL",modifier:"AREA",modifierValue:3,secondaryMovement:3,secondaryDefense:3,item:"RANGE"}],So=[{name:"Claws That Catch",description:`Before the attack: If enraged, you may
...
discards a card, if able.`,color:"GREEN",level:2,variant:{first:1,second:2},initiative:3,primaryAction:"DEFENSE",primaryValueSign:"EXCLAMATION",modifier:"RANGE",modifierValue:3,secondaryMovement:2,item:"ATTACK"},{name:"Kinetic Repulse",description:`Push up to 2 enemy units adjacent to you
...
>>That hero discards a card, or is defeated.
>>You may defeat up to 3 minions adjacent to you.`,color:"BLUE",level:3,variant:{first:2,second:2},initiative:11,primaryAction:"SKILL",modifier:"RANGE",modifierValue:3,secondaryMovement:2,secondaryDefense:6,item:"ATTACK"},{name:"Blood Frenzy",description:`Target a unit adjacent to you.
...
action on one of your faceup skill cards.`,color:"PURPLE",level:4}],Co=[{name:"Tree Slam",description:`If you are adjacent to a tree token, target
a unit in range, otherwise, target a minion
adjacent to you. After the attack:
If the target was adjacent to you, move it
1 space to a space adjacent to you, if able.`,color:"GOLD",initiative:11,primaryAction:"ATTACK",primaryValue:4,modifier:"RANGE",modifierValue:1,secondaryMovement:1,secondaryDefense:3},{name:"Makeshift Weapon",description:`**Choose one —**
>>Target a hero adjacent to you.
>>Remove a ::token_tree:: Tree token adjacent to you.
>Target a hero in range.`,color:"GOLD",handicapped:!0,initiative:10,primaryAction:"ATTACK",primaryValue:3,modifier:"RANGE",modifierValue:2,secondaryMovement:1,secondaryDefense:2},{name:"Mystic Saplings",description:`Place up to 3 ::token_tree:: tree tokens in radius, not
adjacent to a tree token. Heroes may move
through a space with a tree token. Do not
remove the tree tokens at the end of round.`,color:"SILVER",initiative:4,primaryAction:"SKILL",modifier:"AREA",modifierValue:3,secondaryDefense:3},{name:"March of Nature",description:`Adjacent Tree tokens in a battle zone count as
melee minions immune to ranged attacks.`,color:"PURPLE",level:4},{name:"Gifts of Nature",description:`If you are adjacent to a tree, you
...
defeat up to 2 minion you moved through.`,color:"RED",level:3,variant:{first:2,second:2},initiative:8,primaryAction:"MOVEMENT",primaryValue:4,secondaryDefense:8,item:"AREA"},{name:"Treetop Ride",description:`Swap places with a tree token in radius.
You may then place a minion adjacent to that
tree token into a space adjacent to you.`,color:"GREEN",level:3,variant:{first:2,second:2},initiative:5,primaryAction:"DEFENSE_SKILL",primaryValue:4,modifier:"AREA",modifierValue:4,secondaryMovement:2,item:"DEFENSE"}],_o=[{name:"Cleave",description:`Target a unit adjacent to you.
...
for each enemy unit adjacent to you.`,color:"RED",level:2,variant:{first:2,second:2},initiative:8,primaryAction:"ATTACK",primaryValue:3,modifier:"RANGE",modifierValue:1,secondaryMovement:4,secondaryDefense:4,item:"DEFENSE"},{name:"Constrict",description:`**End of round:** Defeat an enemy
